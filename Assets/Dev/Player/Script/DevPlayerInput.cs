...
//     version 1.5.1
//     from Assets/Dev/Player/Script/DevPlayerInput.inputactions
//
...
public partial class @DevPlayerInput: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @DevPlayerInput()
    {
    ...
    {
        private @DevPlayerInput m_Wrapper;
        public DefaultActions(@DevPlayerInput wrapper) { m_Wrapper = wrapper; }
